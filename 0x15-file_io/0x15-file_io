...
OBJECTIVES
At the end of this project, you are expected tto have learnt:
1. How to create, open, close, read and write file
s
2. What are file descriptor
3. What are the 3 standard file descriptors, what are their purpose and what are their POSIX name
